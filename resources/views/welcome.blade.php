...
<head>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background: linear-gradient(135deg, rgba(7, 41, 31, 0.88) 0%, rgba(11, 61, 46, 0.82) 100%),
            ...
            <div class="row g-4 pb-4">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <ul class="list-unstyled text-secondary small" style="line-height: 1.8;">
                        <li class="mb-2">
                            <i class="fa-solid fa-location-dot text-warning me-2"></i> Purwokerto, Kabupaten Banyumas, Jawa Tengah
                        </li>
                        <li class="mb-2">
                            <i class="fa-solid fa-envelope text-warning me-2"></i> info@dharmoyuwono.sch.id
                        </li>
                        <li class="mb-2">
